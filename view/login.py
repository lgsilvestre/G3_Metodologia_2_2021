...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog):
        ...
        self.frame_2.setGeometry(QtCore.QRect(20, 10, 800, 51))
        ...
        self.superAdminBtn = QtWidgets.QRadioButton(self.frame_2)
        self.superAdminBtn.setGeometry(QtCore.QRect(115, 10, 150, 23))
        self.superAdminBtn.setObjectName("superAdminBtn")
        self.userBtn = QtWidgets.QRadioButton(self.frame_2)
        self.userBtn.setGeometry(QtCore.QRect(280, 10, 115, 23))
        self.userBtn.setObjectName("userBtn")
        self.adminBtn = QtWidgets.QRadioButton(self.frame_2)
        self.adminBtn.setGeometry(QtCore.QRect(0, 10, 110, 23))
        self.adminBtn.setObjectName("adminBtn")
        self.pushButton = QtWidgets.QPushButton(self.frame_2)
        self.pushButton.setGeometry(QtCore.QRect(400, 10, 100, 23))
